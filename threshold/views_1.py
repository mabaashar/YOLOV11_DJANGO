...
from threshold.forms import ImageUploadForm, VideoUploadForm
...
#========================================================================================================
        ...
        if request.POST:
            ...
            if form.is_valid():
                ...
                uploaded = request.FILES['video'].read()
                ...
                if c != -1:
                    ...
                    try:
                        cap=cv2.VideoCapture('static/threshold/video/' + str(c))
                    except Exception as e:
                        print(e)
                    try:
                        out=cv2.VideoWriter('static/threshold/out.avi', cv2.VideoWriter_fourcc('M', 'J', 'P', 'G'), 10, (800, 600))
                    except Exception as e:
                        print(e)
                    while True:
